                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li>
                                        <a href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 2]) }}">
                                            {{ trans('ticketit::admin.index-3-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 5]) }}">
                                            {{ trans('ticketit::admin.index-6-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 11]) }}">
