                    ...
                    <div class="card-header d-flex justify-content-between align-items-baseline flex-wrap">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 2]) }}">
                                    {{ trans('ticketit::admin.index-3-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 5]) }}">
                                    {{ trans('ticketit::admin.index-6-months') }}
                                </a>
                                <a class="dropdown-item" href="{{ action('\Kordy\Ticketit\Controllers\DashboardController@index', ['indicator_period' => 11]) }}">
